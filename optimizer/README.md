...
- [Writing an LLVM Pass](https://releases.llvm.org/14.0.6/docs/WritingAnLLVMNewPMPass.html)
- [Using the New Pass Manager](https://releases.llvm.org/14.0.6/docs/NewPassManager.html)
